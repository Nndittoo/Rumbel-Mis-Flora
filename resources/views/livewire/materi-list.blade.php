        ...
        <div>
            ...
            <div class="flex gap-3">
               <button wire:click="clearFilters()" class="text-blue-500 hover:text-red-500 hover:rotate-90 transition ease-in-out 300ms">
                ...
                <p class="text-2xl font-medium">Mata Pelajaran : </p>
            <x-badge wire:navigate href="{{ route('home', ['mapel' => $this->activeMapel->slug]) }}" :textColor="$this->activeMapel->text_color" :bgColor="$this->activeMapel->bg_color">
